...
Note: If you want to try out other variables, I found that the [US Census Burea Factfinder](https://factfinder.census.gov/faces/nav/jsf/pages/index.xhtml) is a great place to pull data from.
